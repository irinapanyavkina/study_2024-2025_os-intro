...
# Выполнение лабораторной работы
  ...
  Создаю файл, дважды копирую его с новыми именами и проверяю, чтобы все команды были выполнены корректно (рис. [-@fig:001]).

![Создание файла](image/lab7.1.png){#fig:001 width=70%}

  Создаю директорию, копирую в нее два файла, созданных на прошлом этапе, проверяю, чтобы все скопировалось (рис. [-@fig:002]).

![Создание директории](image/lab7.2.png){#fig:002 width=70%}

  Копирую файл, находящийся не в текущей директории в файл с новым именем тоже не текущей директории (рис. [-@fig:003]).
...
![Переименовывание файла](image/lab7.5.png){#fig:005 width=70%}
  ...
  Создаю новую директорию, переименовываю monthly.00 в monthly.01, перемещаю директорию в директорию reports, переименовываю эту директорию, убираю из названия 01 (рис. [-@fig:006]).

![Создание директории](image/lab7.6.png){#fig:006 width=70%}

  Создаю пустой файл, проверяю права доступа у него, изменяю права доступа, добавляя пользователю (создателю) возможность выполнять файл  (рис. [-@fig:007]).
...
![Работа с правами доступа](image/lab7.8.png){#fig:008 width=70%}
  ...
  Изменяю права доступа у директории, запрещаю группам и остальным пользователям читать. Создаю новый пустой файл, даю ему права доступа: группы могут в этом файле читать и писать содержимое (рис. [-@fig:009]).
...
![Работа с правами доступа](image/lab7.14.png){#fig:014 width=70%}
  ...
  Проверяю, какие права нужно поменять и как, чтобы у новых файлов были нужные по заданию права.  (рис. [-@fig:015]).

![Работа с правами доступа](image/lab7.15.png){#fig:015 width=70%}

  Создаю файл, добавляю в правах доступа право на исполнение и убираю право на запись для владельца, затем создаю следующий файл, ему в правах доступа добавляю право на запись для группы (рис. [-@fig:016]).

![Работа с правами доступа](image/lab7.16.png){#fig:016 width=70%}

  Читаю содержимое файла (рис. [-@fig:017]).
...
![Копирование файла](image/lab7.18.png){#fig:018 width=70%}
  ...
  Убираю право на чтение у файла для создателя, поэтому не могу его прочесть, также не могу его скопировать, потому что отказано в доступе на чтение, затем возвращаю все права (рис. [-@fig:019]).

![Работа с правами доступа](image/lab7.19.png){#fig:019 width=70%}

  Убираю у директории право на исполнение для пользователя, пытаюсь в нее войти - отказано в доступе, затем возвращаю все права (рис. [-@fig:020]).
