...
![Создание файла через vi](image/lab10.1.png){#fig:001 width=70%}
  ...
  Нажимаю i, чтобы начать редактирование и добавление текста (режим добавления), далее добавляю текст (рис. [-@fig:002]).
...
![Граф взаимосвязи режимов работы редактора vi](image/lab10.13.jpg){#fig:013 width=70%}
